        ...
        {count > visible && (
          <>
            <button
              ...
              disabled={animating}
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-white/10 border border-border backdrop-blur-md text-text hover:bg-primary hover:text-black hover:border-primary transition-all flex items-center justify-center shadow-lg disabled:opacity-50"
            ...
            <button
              ...
              disabled={animating}
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-white/10 border border-border backdrop-blur-md text-text hover:bg-primary hover:text-black hover:border-primary transition-all flex items-center justify-center shadow-lg disabled:opacity-50"
